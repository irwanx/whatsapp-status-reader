export const command = ["wangy", "nenen", "simp", "sherk", "wangy2"]
export const help = ["wangy <nama>", "nenen <nama>", "simp <nama>", "sherk <nama>", "wangy2 <nama>"]
export const tags = ["fun"]

export default async function stres({m}){
    const command = m.command
    const text = m.text
    const simp = async (name) => {
